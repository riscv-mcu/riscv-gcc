...
;; xl_vqmacc   vector matrix integer multiply-add instructions
...
(define_attr "type"
  "unknown,branch,jump,jalr,ret,call,load,fpload,store,fpstore,mac,
   ...
   vsha2ms,vsha2ch,vsha2cl,vsm4k,vsm4r,vsm3me,vsm3c,vfncvtbf16,vfwcvtbf16,vfwmaccbf16,simd,psimd,dsp,dsp64"
...
(include "nuclei-100.md")
(include "nuclei-200.md")
