...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  DIRECT_NAMED (crasv2hi, crasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (crasv2hi, v_ucrasv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (crasv2hi, v_scrasv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (cras16_64, crasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (cras16_64, v_ucrasv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),
  DIRECT_NAMED (cras16_64, v_scrasv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (rcrasv2hi, rcrasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rcrasv2hi, v_rcrasv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (rcras16_64, rcrasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rcras16_64, v_rcrasv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (urcrasv2hi, urcrasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urcrasv2hi, v_urcrasv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (urcras16_64, urcrasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urcras16_64, v_urcrasv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (kcrasv2hi, kcrasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kcrasv2hi, v_kcrasv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kcras16_64, kcrasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kcras16_64, v_kcrasv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (ukcrasv2hi, ukcrasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukcrasv2hi, v_ukcrasv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (ukcras16_64, ukcrasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukcras16_64, v_ukcrasv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (crsav2hi, crsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (crsav2hi, v_ucrsav2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (crsav2hi, v_scrsav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (crsa16_64, crsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (crsa16_64, v_ucrsav4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),
  DIRECT_NAMED (crsa16_64, v_scrsav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (rcrsav2hi, rcrsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rcrsav2hi, v_rcrsav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (rcrsa16_64, rcrsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rcrsa16_64, v_rcrsav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (urcrsav2hi, urcrsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urcrsav2hi, v_urcrsav2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (urcrsa16_64, urcrsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urcrsa16_64, v_urcrsav4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (kcrsav2hi, kcrsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kcrsav2hi, v_kcrsav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kcrsa16_64, kcrsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kcrsa16_64, v_kcrsav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (ukcrsav2hi, ukcrsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukcrsav2hi, v_ukcrsav2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (ukcrsa16_64, ukcrsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukcrsa16_64, v_ukcrsav4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (stasv2hi, stasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (stasv2hi, v_ustasv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (stasv2hi, v_sstasv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (stas16_64, stasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (stas16_64, v_ustasv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),
  DIRECT_NAMED (stas16_64, v_sstasv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (rstasv2hi, rstasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rstasv2hi, v_rstasv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (rstas16_64, rstasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rstas16_64, v_rstasv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (urstasv2hi, urstasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urstasv2hi, v_urstasv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (urstas16_64, urstasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urstas16_64, v_urstasv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (kstasv2hi, kstasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kstasv2hi, v_kstasv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kstas16_64, kstasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kstas16_64, v_kstasv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (ukstasv2hi, ukstasv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukstasv2hi, v_ukstasv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (ukstas16_64, ukstasv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukstas16_64, v_ukstasv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (stsav2hi, stsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (stsav2hi, v_ustsav2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (stsav2hi, v_sstsav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (stsa16_64, stsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (stsa16_64, v_ustsav4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),
  DIRECT_NAMED (stsa16_64, v_sstsav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (rstsav2hi, rstsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rstsav2hi, v_rstsav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (rstsa16_64, rstsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rstsa16_64, v_rstsav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (urstsav2hi, urstsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urstsav2hi, v_urstsav2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (urstsa16_64, urstsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (urstsa16_64, v_urstsav4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (kstsav2hi, kstsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kstsav2hi, v_kstsav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kstsa16_64, kstsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kstsa16_64, v_kstsav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (ukstsav2hi, ukstsav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukstsav2hi, v_ukstsav2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (ukstsa16_64, ukstsav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukstsa16_64, v_ukstsav4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),
  ...
  DIRECT_NAMED (raddv4qi3, raddv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (raddv4qi3, v_raddv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (raddv8qi3, raddv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (raddv8qi3, v_raddv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (uraddv4qi3, uraddv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uraddv4qi3, v_uraddv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (uraddv8qi3, uraddv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uraddv8qi3, v_uraddv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (kaddv4qi3, kaddv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kaddv4qi3, v_kaddv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (kaddv8qi3, kaddv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kaddv8qi3, v_kaddv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (ukaddv4qi3, ukaddv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukaddv4qi3, v_ukaddv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (ukaddv8qi3, ukaddv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ukaddv8qi3, v_ukaddv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (subv4qi3, subv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (subv4qi3, v_ssubv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (subv4qi3, v_usubv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),

  DIRECT_NAMED (subv8qi3, subv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (subv8qi3, v_ssubv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),
  DIRECT_NAMED (subv8qi3, v_usubv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (rsubv4qi3, rsubv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rsubv4qi3, v_rsubv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (rsubv8qi3, rsubv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (rsubv8qi3, v_rsubv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (ursubv4qi3, ursubv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ursubv4qi3, v_ursubv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (ursubv8qi3, ursubv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ursubv8qi3, v_ursubv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (ksubv4qi3, ksubv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ksubv4qi3, v_ksubv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (ksubv8qi3, ksubv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ksubv8qi3, v_ksubv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (uksubv4qi3, uksubv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uksubv4qi3, v_uksubv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (uksubv8qi3, uksubv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uksubv8qi3, v_uksubv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  /* 16-bit shit operations */
  DIRECT_NAMED (ashrv2hi3, srav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashrv2hi3, v_srav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, USI), dsp),
  DIRECT_NAMED (ashrv4hi3, srav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashrv4hi3, v_srav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, USI), dsp),

  DIRECT_NAMED (sra16_roundv2hi, srav2hi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sra16_roundv2hi, v_srav2hi_u,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, USI), dsp),
  DIRECT_NAMED (sra16_roundv4hi, srav4hi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sra16_roundv4hi, v_srav4hi_u,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, USI), dsp),

  DIRECT_NAMED (lshrv2hi3, srlv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (lshrv2hi3, v_srlv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, USI), dsp),
  DIRECT_NAMED (lshrv4hi3, srlv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (lshrv4hi3, v_srlv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, USI), dsp),

  DIRECT_NAMED (srl16_roundv2hi, srlv2hi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (srl16_roundv2hi, v_srlv2hi_u,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, USI), dsp),
  DIRECT_NAMED (srl16_roundv4hi, srlv4hi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (srl16_roundv4hi, v_srlv4hi_u,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, USI), dsp),

  DIRECT_NAMED (ashlv2hi3, sllv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashlv2hi3, v_sllv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, USI), dsp),
  DIRECT_NAMED (ashlv4hi3, sllv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashlv4hi3, v_sllv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, USI), dsp),

  DIRECT_NAMED (kslli16v2hi, ksllv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (kslli16v2hi, v_ksllv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, USI), dsp),
  DIRECT_NAMED (kslli16v4hi, ksllv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (kslli16v4hi, v_ksllv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, USI), dsp),

  DIRECT_NAMED (kslrav2hisi, kslrav2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav2hisi, v_kslrav2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, SI), dsp),
  DIRECT_NAMED (kslrav4hidi, kslrav4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav4hidi, v_kslrav4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, SI), dsp),

  DIRECT_NAMED (kslrav2hisi_round, kslrav2hi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav2hisi_round, v_kslrav2hi_u,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, SI), dsp),
  DIRECT_NAMED (kslrav4hidi_round, kslrav4hi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav4hidi_round, v_kslrav4hi_u,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, SI), dsp),

  /* 8-bit shit operations */
  DIRECT_NAMED (ashrv4qi3, srav4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashrv4qi3, v_srav4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, USI), dsp),
  DIRECT_NAMED (ashrv8qi3, srav8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashrv8qi3, v_srav8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, USI), dsp),

  DIRECT_NAMED (sra8_roundv4qi, srav4qi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sra8_roundv4qi, v_srav4qi_u,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, USI), dsp),
  DIRECT_NAMED (sra8_roundv8qi, srav8qi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sra8_roundv8qi, v_srav8qi_u,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, USI), dsp),

  DIRECT_NAMED (lshrv4qi3, srlv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (lshrv4qi3, v_srlv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, USI), dsp),
  DIRECT_NAMED (lshrv8qi3, srlv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (lshrv8qi3, v_srlv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, USI), dsp),

  DIRECT_NAMED (srl8_roundv4qi, srlv4qi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (srl8_roundv4qi, v_srlv4qi_u,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, USI), dsp),
  DIRECT_NAMED (srl8_roundv8qi, srlv8qi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (srl8_roundv8qi, v_srlv8qi_u,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, USI), dsp),

  DIRECT_NAMED (ashlv4qi3, sllv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashlv4qi3, v_sllv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, USI), dsp),
  DIRECT_NAMED (ashlv8qi3, sllv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (ashlv8qi3, v_sllv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, USI), dsp),

  DIRECT_NAMED (kslli8v4qisi, ksllv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (kslli8v4qisi, v_ksllv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, USI), dsp),
  DIRECT_NAMED (kslli8v8qidi, ksllv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (kslli8v8qidi, v_ksllv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, USI), dsp),

  DIRECT_NAMED (kslrav4qisi, kslrav4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav4qisi, v_kslrav4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, SI), dsp),
  DIRECT_NAMED (kslrav8qidi, kslrav8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav8qidi, v_kslrav8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, SI), dsp),

  DIRECT_NAMED (kslrav4qisi_round, kslrav4qi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav4qisi_round, v_kslrav4qi_u,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, SI), dsp),
  DIRECT_NAMED (kslrav8qidi_round, kslrav8qi_u,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, SI), dsp),
  DIRECT_NAMED (kslrav8qidi_round, v_kslrav8qi_u,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, SI), dsp),

  DIRECT_NAMED (cmpeqv2hi, cmpeqv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (cmpeqv2hi, v_scmpeqv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (cmpeqv2hi, v_ucmpeqv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (cmpeqv4hi, cmpeqv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (cmpeqv4hi, v_scmpeqv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, V4HI, V4HI), dsp),
  DIRECT_NAMED (cmpeqv4hi, v_ucmpeqv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (scmpltv2hi, scmpltv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmpltv2hi, v_scmpltv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (scmpltv4hi, scmpltv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmpltv4hi, v_scmpltv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (scmplev2hi, scmplev2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmplev2hi, v_scmplev2hi,
		RISCV_FTYPE_NAME2 (UV2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (scmplev4hi, scmplev4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmplev4hi, v_scmplev4hi,
		RISCV_FTYPE_NAME2 (UV4HI, V4HI, V4HI), dsp),

  DIRECT_NAMED (ucmpltv2hi, ucmpltv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmpltv2hi, v_ucmpltv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (ucmpltv4hi, ucmpltv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmpltv4hi, v_ucmpltv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (ucmplev2hi, ucmplev2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmplev2hi, v_ucmplev2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (ucmplev4hi, ucmplev4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmplev4hi, v_ucmplev4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),

  DIRECT_NAMED (cmpeqv4qi, cmpeqv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (cmpeqv4qi, v_scmpeqv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (cmpeqv4qi, v_ucmpeqv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (cmpeqv8qi, cmpeqv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (cmpeqv8qi, v_scmpeqv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, V8QI, V8QI), dsp),
  DIRECT_NAMED (cmpeqv8qi, v_ucmpeqv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (scmpltv4qi, scmpltv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmpltv4qi, v_scmpltv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (scmpltv8qi, scmpltv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmpltv8qi, v_scmpltv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (scmplev4qi, scmplev4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmplev4qi, v_scmplev4qi,
		RISCV_FTYPE_NAME2 (UV4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (scmplev8qi, scmplev8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (scmplev8qi, v_scmplev8qi,
		RISCV_FTYPE_NAME2 (UV8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (ucmpltv4qi, ucmpltv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmpltv4qi, v_ucmpltv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (ucmpltv8qi, ucmpltv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmpltv8qi, v_ucmpltv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (ucmplev4qi, ucmplev4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmplev4qi, v_ucmplev4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (ucmplev8qi, ucmplev8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (ucmplev8qi, v_ucmplev8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

//  DIRECT_NAMED (smul16, smul16_32,
//		RISCV_FTYPE_NAME2 (UDI, USI, USI), dsp),
//  DIRECT_NAMED (smul16, v_smul16_32,
//		RISCV_FTYPE_NAME2 (V2SI, V2HI, V2HI), dsp),
//  DIRECT_NAMED (smulx16, smulx16_32,
//		RISCV_FTYPE_NAME2 (UDI, USI, USI), dsp),
//  DIRECT_NAMED (smulx16, v_smulx16_32,
//		RISCV_FTYPE_NAME2 (V2SI, V2HI, V2HI), dsp),

//  DIRECT_NAMED (smul8, smul8_32,
//		RISCV_FTYPE_NAME2 (UDI, USI, USI), dsp),
//  DIRECT_NAMED (smul8, v_smul8_32,
//		RISCV_FTYPE_NAME2 (V4HI, V4QI, V4QI), dsp),
//  DIRECT_NAMED (smulx8, smulx8_32,
//		RISCV_FTYPE_NAME2 (UDI, USI, USI), dsp),
//  DIRECT_NAMED (smulx8, v_smulx8_32,
//		RISCV_FTYPE_NAME2 (V4HI, V4QI, V4QI), dsp),

//  DIRECT_NAMED (khm16v2hi, khm16v2hi,
//		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//  DIRECT_NAMED (khm16v2hi, v_khm16v2hi,
//		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
//  DIRECT_NAMED (khm16v4hi, khm16v4hi,
//		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//  DIRECT_NAMED (khm16v4hi, khm16v4hi,
//		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),
//  DIRECT_NAMED (khmx16v2hi, khmx16v2hi,
//		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//  DIRECT_NAMED (khmx16v2hi, v_khmx16v2hi,
//		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
//  DIRECT_NAMED (khmx16v4hi, khmx16v4hi,
//		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//  DIRECT_NAMED (khmx16v4hi, khmx16v4hi,
//		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),

//   DIRECT_NAMED (khm8v4qi, khm8v4qi,
// 		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//   DIRECT_NAMED (khm8v4qi, v_khm8v4qi,
// 		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
//   DIRECT_NAMED (khm8v8qi, khm8v8qi,
// 		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//   DIRECT_NAMED (khm8v8qi, khm8v8qi,
// 		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),
//   DIRECT_NAMED (khmx8v4qi, khmx8v4qi,
// 		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//   DIRECT_NAMED (khmx8v4qi, v_khmx8v4qi,
// 		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
//   DIRECT_NAMED (khmx8v8qi, khmx8v8qi,
// 		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
//   DIRECT_NAMED (khmx8v8qi, khmx8v8qi,
// 		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (sminv2hi3, sminv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sminv2hi3, v_sminv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (sminv4hi3, sminv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sminv4hi3, v_sminv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),
  DIRECT_NAMED (sminv4qi3, sminv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sminv4qi3, v_sminv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (sminv8qi3, sminv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sminv8qi3, v_sminv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (uminv2hi3, uminv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uminv2hi3, v_uminv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (uminv4hi3, uminv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uminv4hi3, v_uminv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),
  DIRECT_NAMED (uminv4qi3, uminv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uminv4qi3, v_uminv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (uminv8qi3, uminv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (uminv8qi3, v_uminv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (smaxv2hi3, smaxv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smaxv2hi3, v_smaxv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, V2HI), dsp),
  DIRECT_NAMED (smaxv4hi3, smaxv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smaxv4hi3, v_smaxv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, V4HI), dsp),
  DIRECT_NAMED (smaxv4qi3, smaxv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smaxv4qi3, v_smaxv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, V4QI), dsp),
  DIRECT_NAMED (smaxv8qi3, smaxv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smaxv8qi3, v_smaxv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, V8QI), dsp),

  DIRECT_NAMED (umaxv2hi3, umaxv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (umaxv2hi3, v_umaxv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, UV2HI), dsp),
  DIRECT_NAMED (umaxv4hi3, umaxv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (umaxv4hi3, v_umaxv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, UV4HI), dsp),
  DIRECT_NAMED (umaxv4qi3, umaxv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (umaxv4qi3, v_umaxv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, UV4QI), dsp),
  DIRECT_NAMED (umaxv8qi3, umaxv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (umaxv8qi3, v_umaxv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, UV8QI), dsp),

  DIRECT_NAMED (sclip16v2hi, sclipv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sclip16v2hi, v_sclipv2hi,
		RISCV_FTYPE_NAME2 (V2HI, V2HI, USI), dsp),
  DIRECT_NAMED (sclip16v4hi, sclipv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sclip16v4hi, v_sclipv4hi,
		RISCV_FTYPE_NAME2 (V4HI, V4HI, USI), dsp),

  DIRECT_NAMED (uclip16v2hi, uclipv2hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (uclip16v2hi, v_uclipv2hi,
		RISCV_FTYPE_NAME2 (UV2HI, UV2HI, USI), dsp),
  DIRECT_NAMED (uclip16v4hi, uclipv4hi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (uclip16v4hi, v_uclipv4hi,
		RISCV_FTYPE_NAME2 (UV4HI, UV4HI, USI), dsp),

  DIRECT_NAMED (kabsv2hi2, kabsv2hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kabsv2hi2, v_kabsv2hi,
		RISCV_FTYPE_NAME1 (V2HI, V2HI), dsp),
  DIRECT_NAMED (kabsv4hi2, kabsv4hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kabsv4hi2, v_kabsv4hi,
		RISCV_FTYPE_NAME1 (V4HI, V4HI), dsp),

  DIRECT_NAMED (clrsv2hi2, clrsv2hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clrsv2hi2, v_clrsv2hi,
		RISCV_FTYPE_NAME1 (V2HI, V2HI), dsp),
  DIRECT_NAMED (clrsv4hi2, clrsv4hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clrsv4hi2, v_clrsv4hi,
		RISCV_FTYPE_NAME1 (V4HI, V4HI), dsp),

  DIRECT_NAMED (clzv2hi2, clzv2hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clzv2hi2, v_clzv2hi,
		RISCV_FTYPE_NAME1 (V2HI, V2HI), dsp),
  DIRECT_NAMED (clzv4hi2, clzv4hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clzv4hi2, v_clzv4hi,
		RISCV_FTYPE_NAME1 (V4HI, V4HI), dsp),

  DIRECT_NAMED (clov2hi2, clov2hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clov2hi2, v_clov2hi,
		RISCV_FTYPE_NAME1 (V2HI, V2HI), dsp),
  DIRECT_NAMED (clov4hi2, clov4hi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clov4hi2, v_clov4hi,
		RISCV_FTYPE_NAME1 (V4HI, V4HI), dsp),

  DIRECT_NAMED (sclip8v4qi, sclipv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sclip8v4qi, v_sclipv4qi,
		RISCV_FTYPE_NAME2 (V4QI, V4QI, USI), dsp),
  DIRECT_NAMED (sclip8v8qi, sclipv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (sclip8v8qi, v_sclipv8qi,
		RISCV_FTYPE_NAME2 (V8QI, V8QI, USI), dsp),

  DIRECT_NAMED (uclip8v4qi, uclipv4qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (uclip8v4qi, v_uclipv4qi,
		RISCV_FTYPE_NAME2 (UV4QI, UV4QI, USI), dsp),
  DIRECT_NAMED (uclip8v8qi, uclipv8qi,
		RISCV_FTYPE_NAME2 (uintXLEN, uintXLEN, USI), dsp),
  DIRECT_NAMED (uclip8v8qi, v_uclipv8qi,
		RISCV_FTYPE_NAME2 (UV8QI, UV8QI, USI), dsp),

  DIRECT_NAMED (kabsv4qi2, kabsv4qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kabsv4qi2, v_kabsv4qi,
		RISCV_FTYPE_NAME1 (V4QI, V4QI), dsp),
  DIRECT_NAMED (kabsv8qi2, kabsv8qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kabsv8qi2, v_kabsv8qi,
		RISCV_FTYPE_NAME1 (V8QI, V8QI), dsp),

  DIRECT_NAMED (clrsv4qi2, clrsv4qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clrsv4qi2, v_clrsv4qi,
		RISCV_FTYPE_NAME1 (V4QI, V4QI), dsp),
  DIRECT_NAMED (clrsv8qi2, clrsv8qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clrsv8qi2, v_clrsv8qi,
		RISCV_FTYPE_NAME1 (V8QI, V8QI), dsp),

  DIRECT_NAMED (clzv4qi2, clzv4qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clzv4qi2, v_clzv4qi,
		RISCV_FTYPE_NAME1 (V4QI, V4QI), dsp),
  DIRECT_NAMED (clzv8qi2, clzv8qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clzv8qi2, v_clzv8qi,
		RISCV_FTYPE_NAME1 (V8QI, V8QI), dsp),

  DIRECT_NAMED (clov4qi2, clov4qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clov4qi2, v_clov4qi,
		RISCV_FTYPE_NAME1 (V4QI, V4QI), dsp),
  DIRECT_NAMED (clov8qi2, clov8qi,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (clov8qi2, v_clov8qi,
		RISCV_FTYPE_NAME1 (V8QI, V8QI), dsp),

  DIRECT_NAMED (sunpkd810, sunpkd810_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sunpkd810, v_sunpkd810_32,
		RISCV_FTYPE_NAME1 (V2HI, V4QI), dsp),

  DIRECT_NAMED (sunpkd820, sunpkd820_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sunpkd820, v_sunpkd820_32,
		RISCV_FTYPE_NAME1 (V2HI, V4QI), dsp),

  DIRECT_NAMED (sunpkd830, sunpkd830_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sunpkd830, v_sunpkd830_32,
		RISCV_FTYPE_NAME1 (V2HI, V4QI), dsp),

  DIRECT_NAMED (sunpkd831, sunpkd831_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sunpkd831, v_sunpkd831_32,
		RISCV_FTYPE_NAME1 (V2HI, V4QI), dsp),

  DIRECT_NAMED (sunpkd832, sunpkd832_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (sunpkd832, v_sunpkd832_32,
		RISCV_FTYPE_NAME1 (V2HI, V4QI), dsp),

  DIRECT_NAMED (zunpkd810, zunpkd810_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (zunpkd810, v_zunpkd810_32,
		RISCV_FTYPE_NAME1 (UV2HI, UV4QI), dsp),

  DIRECT_NAMED (zunpkd820, zunpkd820_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (zunpkd820, v_zunpkd820_32,
		RISCV_FTYPE_NAME1 (UV2HI, UV4QI), dsp),

  DIRECT_NAMED (zunpkd830, zunpkd830_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (zunpkd830, v_zunpkd830_32,
		RISCV_FTYPE_NAME1 (UV2HI, UV4QI), dsp),

  DIRECT_NAMED (zunpkd831, zunpkd831_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (zunpkd831, v_zunpkd831_32,
		RISCV_FTYPE_NAME1 (UV2HI, UV4QI), dsp),

  DIRECT_NAMED (zunpkd832, zunpkd832_32,
		RISCV_FTYPE_NAME1 (uintXLEN, uintXLEN), dsp),
  ...
  DIRECT_NAMED (smulsi3_highpart, smulsi,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (smmul_round, smmulsi,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (smulv2si3_highpart, smulv2si,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (smulv2si3_highpart, v_smulv2si,
		RISCV_FTYPE_NAME2 (V2SI, V2SI, V2SI), dsp),
  DIRECT_NAMED (smmulv2si3_round, smmulv2si,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (smmulv2si3_round, v_smmulv2si,
		RISCV_FTYPE_NAME2 (V2SI, V2SI, V2SI), dsp),

  DIRECT_NAMED (kmmac, kmmac,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmac_64, kmmac_64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmac_64, v_kmmac_64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V2SI, V2SI), dsp),

  DIRECT_NAMED (kmmac_round, kmmac_round,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmac64_round, kmmac64_round,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmac64_round, v_kmmac64_round,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V2SI, V2SI), dsp),

  DIRECT_NAMED (kmmsb, kmmsb,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmsb_64, kmmsb_64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmsb_64, v_kmmsb_64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V2SI, V2SI), dsp),

  DIRECT_NAMED (kmmsb_round, kmmsb_round,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmsb64_round, kmmsb64_round,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kmmsb64_round, v_kmmsb64_round,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V2SI, V2SI), dsp),

  DIRECT_NAMED (kwmmul, kwmmul,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kwmmul_64, kwmmul_64,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kwmmul_64, v_kwmmul_64,
		RISCV_FTYPE_NAME2 (V2SI, V2SI, V2SI), dsp),

  DIRECT_NAMED (kwmmul_round, kwmmul_round,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (kwmmul64_round, kwmmul64_round,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  ...
  DIRECT_NAMED (smslda1, smslda,
		RISCV_FTYPE_NAME3 (DI, DI, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smslda1, v_smslda,
		RISCV_FTYPE_NAME3 (DI, DI, V2HI, V2HI), dsp),
  DIRECT_NAMED (smslda64, smslda64,
		RISCV_FTYPE_NAME3 (DI, DI, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smslda64, v_smslda64,
		RISCV_FTYPE_NAME3 (DI, DI, V4HI, V4HI), dsp),

  DIRECT_NAMED (smslxda1, smslxda,
		RISCV_FTYPE_NAME3 (DI, DI, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smslxda1, v_smslxda,
		RISCV_FTYPE_NAME3 (DI, DI, V2HI, V2HI), dsp),
  DIRECT_NAMED (smslxda64, smslxda64,
		RISCV_FTYPE_NAME3 (DI, DI, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smslxda64, v_smslxda64,
		RISCV_FTYPE_NAME3 (DI, DI, V4HI, V4HI), dsp),

  DIRECT_NAMED (smbb, smbbv2hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smbb, v_smbbv2hi,
		RISCV_FTYPE_NAME2 (SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (smbb64, smbbv4hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smbb64, v_smbbv4hi,
		RISCV_FTYPE_NAME2 (V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (smbt, smbtv2hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smbt, v_smbtv2hi,
		RISCV_FTYPE_NAME2 (SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (smbt64, smbtv4hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smbt64, v_smbtv4hi,
		RISCV_FTYPE_NAME2 (V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (smtt, smttv2hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smtt, v_smttv2hi,
		RISCV_FTYPE_NAME2 (SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (smtt64, smttv4hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smtt64, v_smttv4hi,
		RISCV_FTYPE_NAME2 (V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmda, kmdav2hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmda, v_kmdav2hi,
		RISCV_FTYPE_NAME2 (SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmda64, kmdav4hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmda64, v_kmdav4hi,
		RISCV_FTYPE_NAME2 (V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmxda, kmxdav2hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmxda, v_kmxdav2hi,
		RISCV_FTYPE_NAME2 (SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmxda64, kmxdav4hi,
		RISCV_FTYPE_NAME2 (intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmxda64, v_kmxdav4hi,
		RISCV_FTYPE_NAME2 (V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmabb, kmabb,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmabb, v_kmabb,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmabb64, kmabb64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmabb64, v_kmabb64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmabt, kmabt,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmabt, v_kmabt,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmabt64, kmabt64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmabt64, v_kmabt64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmatt, kmatt,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmatt, v_kmatt,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmatt64, kmatt64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmatt64, v_kmatt64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmada, kmada,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmada, v_kmada,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmada64, kmada64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmada64, v_kmada64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmaxda, kmaxda,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmaxda, v_kmaxda,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmaxda64, kmaxda64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmaxda64, v_kmaxda64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmads, kmads,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmads, v_kmads,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmads64, kmads64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmads64, v_kmads64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmadrs, kmadrs,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmadrs, v_kmadrs,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmadrs64, kmadrs64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmadrs64, v_kmadrs64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmaxds, kmaxds,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmaxds, v_kmaxds,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmaxds64, kmaxds64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmaxds64, v_kmaxds64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmsda, kmsda,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmsda, v_kmsda,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmsda64, kmsda64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmsda64, v_kmsda64,
		RISCV_FTYPE_NAME3 (V2SI, V2SI, V4HI, V4HI), dsp),

  DIRECT_NAMED (kmsxda, kmsxda,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (kmsxda, v_kmsxda,
		RISCV_FTYPE_NAME3 (SI, SI, V2HI, V2HI), dsp),
  DIRECT_NAMED (kmsxda64, kmsxda64,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  ...
  DIRECT_NAMED (smaqasi, smaqasi,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smaqadi, smaqadi,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),

  DIRECT_NAMED (umaqasi, umaqasi,
		RISCV_FTYPE_NAME3 (uintXLEN, uintXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (umaqadi, umaqadi,
		RISCV_FTYPE_NAME3 (uintXLEN, uintXLEN, uintXLEN, uintXLEN), dsp),

  DIRECT_NAMED (smaqasusi, smaqasusi,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),
  DIRECT_NAMED (smaqasudi, smaqasudi,
		RISCV_FTYPE_NAME3 (intXLEN, intXLEN, uintXLEN, uintXLEN), dsp),

  DIRECT_NAMED (kaddhsi, kaddhsi,
		RISCV_FTYPE_NAME2 (intXLEN, SI, SI), dsp),
  DIRECT_NAMED (kaddhdi, kaddhdi,
		RISCV_FTYPE_NAME2 (intXLEN, DI, DI), dsp),

  DIRECT_NAMED (ksubhsi, ksubhsi,
		RISCV_FTYPE_NAME2 (intXLEN, SI, SI), dsp),
  DIRECT_NAMED (ksubhdi, ksubhdi,
		RISCV_FTYPE_NAME2 (intXLEN, DI, DI), dsp),

  DIRECT_NAMED (khmbbsi, khmbbsi,
		RISCV_FTYPE_NAME2 (intXLEN, USI, USI), dsp),
  DIRECT_NAMED (khmbbdi, khmbbdi,
		RISCV_FTYPE_NAME2 (intXLEN, UDI, UDI), dsp),

  DIRECT_NAMED (khmbtsi, khmbtsi,
		RISCV_FTYPE_NAME2 (intXLEN, USI, USI), dsp),
  DIRECT_NAMED (khmbtdi, khmbtdi,
		RISCV_FTYPE_NAME2 (intXLEN, UDI, UDI), dsp),

  DIRECT_NAMED (khmttsi, khmttsi,
		RISCV_FTYPE_NAME2 (intXLEN, USI, USI), dsp),
  DIRECT_NAMED (khmttdi, khmttdi,
		RISCV_FTYPE_NAME2 (intXLEN, UDI, UDI), dsp),

  DIRECT_NAMED (ukaddhsi, ukaddhsi,
		RISCV_FTYPE_NAME2 (uintXLEN, USI, USI), dsp),
  DIRECT_NAMED (ukaddhdi, ukaddhdi,
		RISCV_FTYPE_NAME2 (uintXLEN, UDI, UDI), dsp),

  DIRECT_NAMED (uksubhsi, uksubhsi,
		RISCV_FTYPE_NAME2 (uintXLEN, USI, USI), dsp),
  ...
  DIRECT_NAMED (raddwsi, raddwsi,
		RISCV_FTYPE_NAME2 (intXLEN, SI, SI), dsp),
  DIRECT_NAMED (raddwdi, raddwdi,
		RISCV_FTYPE_NAME2 (intXLEN, DI, DI), dsp),

  DIRECT_NAMED (uraddwsi, uraddwsi,
		RISCV_FTYPE_NAME2 (uintXLEN, USI, USI), dsp),
  DIRECT_NAMED (uraddwdi, uraddwdi,
		RISCV_FTYPE_NAME2 (uintXLEN, UDI, UDI), dsp),

  DIRECT_NAMED (rsubwsi, rsubwsi,
		RISCV_FTYPE_NAME2 (intXLEN, SI, SI), dsp),
  DIRECT_NAMED (rsubwdi, rsubwdi,
		RISCV_FTYPE_NAME2 (intXLEN, DI, DI), dsp),

  DIRECT_NAMED (ursubwsi, ursubwsi,
		RISCV_FTYPE_NAME2 (uintXLEN, USI, USI), dsp),
  DIRECT_NAMED (ursubwdi, ursubwdi,
		RISCV_FTYPE_NAME2 (uintXLEN, UDI, UDI), dsp),

  DIRECT_NAMED (avesi, avesi,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),
  DIRECT_NAMED (avedi, avedi,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, intXLEN), dsp),

  DIRECT_NAMED (sraiu, sraiusi,
		RISCV_FTYPE_NAME2 (intXLEN, intXLEN, USI), dsp),
