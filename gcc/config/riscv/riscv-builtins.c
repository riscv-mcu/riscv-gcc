...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  _RVV_INT_ITERATOR_ARG (VINT_UNARY_OP_BUILTINS, neg)
  ...
  _RVV_FLOAT_ITERATOR_ARG (VFLOAT_UNARY_OP_BUILTINS, neg)
  _RVV_FLOAT_ITERATOR_ARG (VFLOAT_UNARY_OP_BUILTINS, rec7)
  _RVV_FLOAT_ITERATOR_ARG (VFLOAT_UNARY_OP_BUILTINS, rsqrt7)
  _RVV_FLOAT_ITERATOR_ARG (VFLOAT_REDUC_OP_BUILTINS, usum)
  ...
  _RVV_WRED_FLOAT_ITERATOR_ARG (VFLOAT_WREDUC_OP_BUILTINS, usum)
  ...
  _RVV_SEG_INT_INDEX_ITERATOR_ARG(VINT_INDEX_SEG_LOAD_STORE_BUILTINS, o)
  _RVV_SEG_INT_INDEX_ITERATOR_ARG(VINT_INDEX_SEG_LOAD_STORE_BUILTINS, u)
